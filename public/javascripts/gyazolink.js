...
$(function() {
  ...
  src = 'fcabe14b63788dca961dad3a9f8796fb';
  src = '1ae719bf0c4eb8607f1cb9b385dbad92';
  display();
...
function search(query){
  ...
  $.getJSON("/search/"+query, function(list){
    showimages(list['ids']);
  });
}
...
function display(){
  ...
  // キーワード表示
  $.getJSON("/attr/"+src, function(attr){
  ...
  $.getJSON("/similar/"+src, function(list){
    images = list['ids'];
    showimages(images);
  });
}
